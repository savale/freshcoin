...
/** Class encapsulating Freshcoin Core startup and shutdown.
...
/** Main Freshcoin application object */
...
*/
        ...
        // freshcoin: URIs or payment requests:
        /*
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Freshcoin Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Freshcoin Core"),
    ...
    if (!SelectParamsFromCommandLine()) {
        QMessageBox::critical(0, QObject::tr("Freshcoin Core"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
#ifdef ENABLE_WALLET
    ...
    // freshcoin: links repeatedly have their payment requests routed to this process:
