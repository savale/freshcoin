...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MFRSH);
    unitlist.append(kFRSH);
    unitlist.append(FRSH);
    unitlist.append(Frshtoid);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    case Frshtoid: return QString("Freshtoid");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case Frshtoid: return QString("Freshtoid (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MFRSH: return Q_INT64_C(100000000000000);
    case kFRSH: return Q_INT64_C(100000000000);
    case FRSH:  return Q_INT64_C(100000000);
    case Frshtoid: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MFRSH: return Q_INT64_C(900000);
    case kFRSH: return Q_INT64_C(900000000);
    case FRSH:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case Frshtoid: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MFRSH: return 6;  // 900,000 (# digits, without commas)
    case kFRSH: return 9;  // 900,000,000
    case FRSH:  return 12; // 900,000,000,000
    case Frshtoid: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MFRSH: return 14;
    case kFRSH: return 11;
    case FRSH: return 8;
    case Frshtoid: return 0;
    default: return 0;
    }
}
