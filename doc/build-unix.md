UNIX BUILD NOTES
====================
Some notes on how to build Freshcoin in Unix. 
...
This will build freshcoin-qt as well if the dependencies are met.
...
If you want to build Freshcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a freshcoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip freshcoind" to strip the debug
